...
export default function SignupPage() {
  ...
  const handleGoogleSuccess = async (credentialResponse: any) => {
    try {
      ...
      // Redirect to home page instead of showing success message
      router.push("/");
    } catch (err) {
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 bg-blue-900/30 text-white border border-blue-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 placeholder-blue-400/50 pr-10"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
